...
const CORE = [
  ...
  "/academic-partnership","/Learning-vigyanllm","/demo","/sitemap","/cookies","/refund","/changelog","/team",
  ...
  "/clustal-vs-mafft","/clustal-vs-tcoffee","/muscle-vs-mafft",
  "/primer3-vs-idt","/primer3-vs-snapgene","/swissdock-vs-haddock",
  ...
  "/glossary/bioinformatics-glossary","/glossary/crispr-glossary",
];

const BLOG = ["restriction-cloning-vs-gibson-assembly", "ai-in-molecular-biology", "ai-primer-design-machine-learning", "amplicon-sequencing-guide", "automated-wet-lab-workflows", "best-free-bioinformatics-tools-2026", "best-primer-design-software-2026", "biotech-ai-future-2026", "bisulfite-conversion-pcr-primer-design", "cfdna-liquid-biopsy-pcr", "colony-pcr-primer-design", "covid-19-rt-pcr-primers", "crispr-grna-design-guide", "degenerate-primer-design", "digital-pcr-vs-qpcr", "gc-content-guidelines", "hepatitis-b-virus-pcr", "hiv-viral-load-pcr", "hot-start-pcr-technology", "hpv-genotyping-pcr", "isothermal-amplification-primers", "listeria-detection-pcr", "llm-for-genomics", "long-range-pcr-nanopore-sequencing-primer-design", "molecular-docking-tutorial", "multiplex-pcr-design", "multiplex-pcr-primer-design", "ncbi-primer-blast-guide", "ncbi-primer-blast-vs-vigyanllm", "nested-pcr-primer-design", "pcr-multiplex-optimization", "pcr-pipette-technique", "pcr-primer-design-rules", "pcr-protocol-beginners", "pcr-steps", "pcr-troubleshooting-guide", "primer-design-basics", "primer-design-complete-guide", "primer-design-india-affordable", "primer-design-mrna", "primer-design-rules", "primer-dimer-fix", "primer-dimer-prevention", "primer3-vs-vigyanllm", "qpcr-primer-probe-design", "real-time-pcr-data-analysis", "rt-pcr-complete-guide", "rt-pcr-vs-qpcr", "sequencing-primer-design", "single-cell-rna-seq-pcr-primer-design", "snapgene-vs-vigyanllm", "taqman-probe-troubleshooting", "taqman-vs-sybr-green", "tm-calculation-methods", "top-10-free-bioinformatics-tools", "touchdown-pcr-protocol", "types-of-pcr", "variant-calling-guide", "vprime-internal-validation", "what-is-pcr", "free-blast-tool-online", "gc-content-calculator-guide", "molecular-docking-software-guide", "pcr-primer-design-step-by-step", "primer-design-tool-comparison", "multiple-sequence-alignment-tools", "dna-to-rna-transcription-online", "crispr-guide-design-comparison", "primer-specificity-check", "primer-dimer-formation", "multiplex-primer-design", "annealing-temperature-optimization", "blastn-vs-blastp", "blast-results-interpretation", "local-blast-setup", "diamond-blastx-guide", "autodock-vina-tutorial", "swissdock-tutorial", "docking-score-interpretation", "protein-ligand-docking-guide", "sequence-alignment-guide", "phylogenetic-tree-construction", "sanger-sequencing-guide", "codon-usage-analysis", "best-free-primer-design-tool-2026", "free-blast-alignment-tool-no-signup", "online-molecular-docking-no-install", "free-sequence-alignment-tool-online", "bioinformatics-tools-for-students"];
const GLOSSARY = ["adme", "alignment", "allele", "alphafold", "alternative-splicing", "amino-acid", "amplicon", "amplicon-size", "annealing-temperature", "antibiotic-resistance", "antibody", "apoptosis", "atp", "bacteriophage", "bam", "base-editing", "base-pair", "binding-affinity", "bioavailability", "bioinformatics", "biomarker", "bisulfite-pcr", "blast", "blast-specificity", "bowtie2-alignment", "cas12", "cas13", "cas9", "cdna-library", "cell", "cell-differentiation", "cell-membrane", "chromosome", "citric-acid-cycle", "clinical-diagnostics", "clinvar", "codon", "confocal-microscopy", "crispr", "crispr-screen", "cytokinesis", "cytoskeleton", "dbsnp", "deep-learning", "degenerate-primer", "delta-g", "diagnostic-sensitivity", "diagnostic-specificity", "digital-pcr", "dna", "dna-helix", "dna-polymerase", "dna-repair", "dominant", "dose-response-curve", "drug-discovery", "e-value", "elisa", "endocytosis", "endoplasmic-reticulum", "enhancer", "ensembl", "enzyme", "epigenetics", "esmfold", "evolution", "exocytosis", "exon", "facs", "fastq", "flow-cytometry", "forward-primer", "gc-clamp", "gc-content", "gel-electrophoresis", "gel-extraction", "gene", "gene-expression", "gene-therapy", "genetic-linkage", "genetic-variant", "genome", "genome-assembly", "genome-editing", "genomics", "genotype", "glycolysis", "gnina", "golgi-apparatus", "gwas", "hairpin", "haplotype", "homologous-recombination", "hot-start-pcr", "ic50", "illumina", "insulin", "interleukin", "intron", "iupac-codes", "karyotype", "lead-compound", "liquid-biopsy", "lysosome", "machine-learning", "manufacturing-qc", "mass-spectrometry", "mass-spectrometry-proteomics", "meiosis", "melting-temperature", "mendelian-inheritance", "metagenomics", "mg2-correction", "microarray", "mirna", "mitochondria", "mitosis", "molecular-biology", "molecular-docking", "mrna", "multiplex-pcr", "mutation", "ncbi", "nearest-neighbor-model", "nested-pcr", "next-generation-sequencing", "northern-blot", "nucleotide", "nucleus", "oncoprotein", "operon", "oxford-nanopore", "oxidative-phosphorylation", "pathogenic-variant", "pcr", "penalty-matrix", "peptide", "phage-display", "pharmacodynamics", "pharmacogenomics", "pharmacokinetics", "phenotype", "phylogeny", "plasmid", "plasmid-purification", "polyadenylation", "polymorphism", "prime-editing", "primer", "primer-design", "primer-dimer", "primer-pooler", "primer-specificity", "primer3", "probe-design", "promoter", "proteasome", "protein", "protein-domain", "protein-structure-prediction", "proteome", "qpcr", "real-time-pcr", "recessive", "repeat-masking", "retrotransposon", "reverse-primer", "ribosome", "rmsd", "rna", "rna-interference", "rna-polymerase", "rna-seq", "rna-splicing", "rt-pcr", "rychlik-formula", "salt-correction", "sanger-sequencing", "santalucia-1998", "secondary-structure", "signal-transduction", "single-cell-rna-seq", "smina", "snp", "snp-filtering", "southern-blot", "sybr-green", "synthetic-biology", "t-cell", "taq-polymerase", "taqman", "taqman-probe", "taxonomy", "thermal-cycler", "thermocycling-profile", "touchdown-pcr", "transcription", "transcriptome", "translation", "transposon", "triplet-code", "trna", "tumor-suppressor", "ubiquitin", "vaccine", "variant-calling", "vcf", "vina", "virtual-screening", "western-blot"];
