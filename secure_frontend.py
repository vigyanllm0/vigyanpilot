...
class SecureHandler(SimpleHTTPRequestHandler):
    ...
    def end_headers(self):
        ...
        self.send_header("Content-Security-Policy", "default-src 'self'; script-src 'self' https://accounts.google.com https://cdn.tailwindcss.com https://checkout.razorpay.com https://cdn.jsdelivr.net https://3Dmol.org 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https:; connect-src 'self' http://localhost:11436 https://www.google-analytics.com https://www.google.com; frame-src https://accounts.google.com https://checkout.razorpay.com")
        super().end_headers()
